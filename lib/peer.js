 ...
 * using the standard ARDcoin protocol. A Peer instance represents one connection
 * on the ARDcoin network. To create a new peer connection provide the host and port

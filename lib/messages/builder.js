...
function builder(options) {
  ...
  if (!options.network) {
    options.network = ARDcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || ARDcore.Block;
  options.BlockHeader = options.BlockHeader || ARDcore.BlockHeader;
  options.Transaction = options.Transaction || ARDcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || ARDcore.MerkleBlock;

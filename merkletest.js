let Pool = require('ARDcore-p2p').Pool;
let BloomFilter = require('ARDcore-p2p').BloomFilter;
let NetworksData = require('ARDcore-lib').Networks;
let Messages = require('ARDcore-p2p').Messages;
...
// Create a filter and a ARD message with the filter
...
// Create a ARD message for require a merkleblock
